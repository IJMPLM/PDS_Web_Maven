...
<body>
    <div id="parent-info" class="col-span-3">
        ...
        <div id="father_name-edit" class="grid-cols-3 gap-y-2 gap-x-8 hidden col-span-6">
        ...
        <div id="mother_name-edit" class="grid-cols-3 gap-y-2 gap-x-8 hidden col-span-6">
