<div id="parent-info" class="col-span-3">
    <div class="grid grid-cols-3 gap-y-4 gap-x-8">
        ...
        <div class="input-container col-span-2">
            <input type="text" class="readonly-input" id="father_name" name="father_name" value="<%= respondent.get("father_lname") + ", " + respondent.get("father_fname") + " " + respondent.get("father_mname") %>" readonly>
        </div>
