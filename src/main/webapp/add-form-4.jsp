<div class="grid grid-cols-6 gap-x-8 gap-y-2 font-[Inter] text-xl">
    <label class="section-header my-12 text-gray-600 col-span-6">Spouse's Information</label>
...
<div class="grid grid-cols-6 gap-x-8 gap-y-2 font-[Inter] text-xl">
    <div class="col-span-3">
        <div class="grid grid-cols-3 gap-y-4 gap-x-8">
            <label class="section-header my-12 text-gray-600 col-span-3">Father's Information</label>
    ...
    <div class="col-span-3">
        <div class="grid grid-cols-3 gap-y-4 gap-x-8">
            <label class="section-header my-12 text-gray-600 col-span-3">Mother's Maiden Information</label>
