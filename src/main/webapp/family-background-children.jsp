<div class="m-16">
    ...
    <div class="mx-16 grid grid-cols-4 gap-16">
        ...
        %>
            ...
            <div class="readonly-input p-6 text-lg">
                <input type="date" class="readonly-input child_dob" id="child_dob_<%= child.get("child_id") %>" col-span-1 name="child_dob_<%= child.get("child_id") %>" value="<%= child.get("child_dob") %>" readonly>
            </div>
        <%
                }
            } else {
